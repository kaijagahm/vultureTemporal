...
ro_density_orig <- map(graphs_roosting, ~map_dbl(.x, ~igraph::edge_density(nonzero(.x))))
ag_density_orig <- map(graphs_aggregate, ~map_dbl(.x, ~igraph::edge_density(nonzero(.x))))
```
...
measures_ro <- getmeasures(ro_density, timewindows_heuristic, "roosting")
measures_ag <- getmeasures(ag_density, timewindows_heuristic, "aggregate")
...
measures_ro_orig <- getmeasures(ro_density_orig, timewindows, "roosting")
measures_ag_orig <- getmeasures(ag_density_orig, timewindows, "aggregate")

all <- list(measures_fl, measures_fe, measures_ro, measures_ag, measures_fl_orig, measures_fe_orig, measures_ro_orig, measures_ag_orig)
